...
function SidebarContent() {
    ...
    const viewAtiva = isHome ? (searchParams.get('view') || 'hoje') : null
    ...
    return (
        ...
        >
                    ...
                    {NAV_VIEWS.map(item => {
                        ...
                        return (
                            <Link
                                ...
                                className={[
                                    'flex items-center rounded-md text-[13px] no-underline transition-colors duration-100',
                            ...
                            >
                                <span className={`text-[13px] w-4 text-center flex-shrink-0 ${active ? 'text-text-primary' : 'text-text-tertiary'}`}>
                                    {item.icon}
                                </span>
                    ...
                    {[
                        ...
                        return (
                            <Link key={href} href={href} title={collapsed ? label : undefined}
                                className={[
                                    'flex items-center rounded-md text-[13px] no-underline transition-colors duration-100 mt-0.5',
            ...
            {/* Google Calendar — só renderiza no cliente para evitar hydration mismatch */}
            {!collapsed && mounted && (
